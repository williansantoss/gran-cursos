...
// Returns the private 'App\Repository\EnderecoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnderecoRepository.php';

return $this->privates['App\Repository\EnderecoRepository'] = new \App\Repository\EnderecoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
