...
// Returns the private 'App\Repository\ContatosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContatosRepository.php';

return $this->privates['App\Repository\ContatosRepository'] = new \App\Repository\ContatosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
